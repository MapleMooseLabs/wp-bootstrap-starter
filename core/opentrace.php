...
add_action('init', 'opentrace_head_cleanup');
/* Cleanup head */
function opentrace_head_cleanup()
{
    // EditURI link
...
} /* end opentrace head cleanup */

/**
 * Include the TGM_Plugin_Activation class.
 */
require_once dirname(__FILE__).'/php/class-tgm-plugin-activation.php';
add_action('tgmpa_register', 'opentrace_register_required_plugins');

/**
 * Register the required plugins.
 */
function opentrace_register_required_plugins()
{
    $plugins = array(
